    ...
    render() {
        ...
        if (this.state.questionsCounter === 0) {//start test
            ...
            <div className="modal">
                ...
                <h3 >!בהצלחה</h3>
                <button className="modalTestButton" onClick={() => this.next()}>התחל מבחן</button>
            </div>
        ...
        if (this.state.questionsCounter > 0 && this.state.questionsCounter < 11) {//changing questions
            ...
            modalContent = 
            <div className="modal">
                <p><b>{this.state.questionsCounter}</b> / 10 שאלה</p>
                ...
                <button className="modalTestButton" onClick={() => this.findAnyCheckedRadio()? this.next() : alert("אנא סמן תשובה") }>המשך</button>
            </div>
        ...
        if (this.state.questionsCounter > 10) {//finish test
            modalContent = <div className="modal">
                ...
                <button className="modalTestButton"  onClick={() => this.finishTest()}>חזרה לדף הבחנים</button>
            </div>
        }
        ...
        return (
            <div className="TestsCaseBox">
                ...
                <Modal isOpen={this.state.modalIsOpen} shouldCloseOnOverlayClick={false} onRequestClose={this.close.bind(this)}
                    ...
                    <h1 className="modal__title">מבחן ב{this.props.title}</h1>
                    {modalContent}
